...
%%% @doc
%%% Serwer dla naszego projektu, który przetrzymuje całą historię oraz zamienia dane na JSON.
%%%
%%% @end
%%% Created : 21. sty 2015 10:16
%%%-------------------------------------------------------------------
%%%-------------------------------------------------------------------
-module(web_scraping_server).
...
%%%===================================================================
%% tutaj mozna by zrobic osobny serwer i za pomoca supervisiora dwa uruchomić
